...
class TestAnalystNodes:
    ...
    def test_create_analysts_success(
        self,
...
class TestReportNodes:
    ...
    def test_write_introduction_success(
        self,
        sample_research_state,
        mock_llm
    ):
    ...
    def test_write_conclusion_success(
        self,
        sample_research_state,
        mock_llm
    ):
    ...
    def test_finalize_report_strips_insights_header(self):
        ...
        assert "## Insights" not in result["final_report"].split("Introduction")[1].split("Conclusion")[0]
...
class TestNodeErrorHandling:
    ...
    def test_create_analysts_llm_failure(
        self,
        sample_generate_analysts_state,
        mock_failing_llm
    ):
    ...
    def test_generate_question_llm_failure(
        self,
        sample_interview_state,
        mock_failing_llm
    ):
    ...
    def test_write_report_llm_failure(
        self,
        sample_research_state,
        mock_failing_llm
    ):
...
class TestNodeIntegration:
    ...
    def test_interview_question_answer_flow(
        self,
        sample_interview_state,
        mock_llm
    ):
...
@pytest.mark.parametrize("max_analysts,expected_valid", [
    (1, True),
    (3, True),
    (10, True),
    (0, False),
...
@pytest.mark.parametrize("feedback,should_approve", [
    ("approve", True),
    ("APPROVE", True),
    ("Approve", True),
    ("  approve  ", True),
